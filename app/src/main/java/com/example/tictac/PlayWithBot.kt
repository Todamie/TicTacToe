...
class PlayWithBot: AppCompatActivity() {

    private lateinit var vm: PlayWithBotViewModel

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.layout_tic_tac)

        val playWithHuman: Button = findViewById(R.id.buttonPlayWithBot)
        playWithHuman.setText("Играть вдвоём")
        ...
        vm = ViewModelProvider(this).get(PlayWithBotViewModel::class.java)
        ...
        //vm.massivSize.observe(this, Observer { buttonBot.text = it })
        //vm.massivColor.observe(this, Observer { colorText.text = it })
        //vm.massivId.observe(this, Observer { idText.text = it })
        ...
        fun setClickListener(button: Button) {
            button.setOnClickListener {
                ...
                vm.botTurn(resources.getResourceEntryName(button.id))
                if (vm.win(
        ...
        playWithHuman.setOnClickListener{
            vm.clear()
